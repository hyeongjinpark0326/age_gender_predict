...
model = keras.models.Sequential([
    ...
    Conv2D(input_shape=(image_w, image_h,3),
          kernel_size=(11,11),  strides=(2,2),filters= 96,padding='same',activation='relu'),
    MaxPooling2D(pool_size=(2, 2)),
    BatchNormalization(),
    keras.layers.Dropout(0.5),

    Conv2D(input_shape=(image_w, image_h,3),
          kernel_size=(5,5),  strides=(2,2), filters= 256,padding='same',activation='relu'),
    MaxPooling2D(pool_size=(2, 2)),
    BatchNormalization(),
    keras.layers.Dropout(0.5),
...
mc = ModelCheckpoint('.age_paper_1024.h5', monitor='val_accuracy', mode='max')
