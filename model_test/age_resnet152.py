...
from tensorflow.keras.preprocessing.image import ImageDataGenerator
from tensorflow.keras.applications import ResNet152, ResNet152V2, InceptionResNetV2
...
model = Sequential()
ResNet152 = ResNet152(input_tensor=input, include_top=False, weights=None, pooling='max')
